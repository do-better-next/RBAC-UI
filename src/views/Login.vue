...
.login .login_main .login_main_left h1 {
    ...
    letter-spacing: 6px;
    line-height: 1;
    text-shadow: 4px 3px 0 #383b3a, 9px 8px 0 rgba(0, 0, 0, .15);
    margin: 0 0 15px;
}
    ...
    <div id="login" class="login animate__animated animate__zoomIn">
        <div class="login_main">
            <div class="login_main_left">
                ...
                <p
                    style="color: #fff; font-size: 14px; width: 25rem;line-height: 1.5;text-align: left;text-indent: 1rem;padding: 1rem 1.5rem;">
                    <i class="fa fa-regular fa-flag "
                        style="color: #ed8b35;margin-right: 5px;"></i>本网站为广大需要资源的网友服务，取之于大家，用之于大家，大家的共同分享，才能使资源发挥最有用的价值！
                </p>
            </div>
            <div class="login_main_right">
                <div :model="countInfo" class="login_input">
                    ...
                    <div v-if="isCount">
                        ...
                        <p @click="phoneLoginPart"><i style="margin-right: .2rem;" class="fa fa-comment-o"></i>短信登录</p>
                    </div>
                    ...
                    <div v-if="isPhone">
                        ...
                        <div style="margin: 20px" />
                        <div class="code">
                            <el-input style="width: 45%;height: 2rem;" v-model="phoneInfo.code" placeholder="验证码" />

                            <el-button style="width: 45%;height: 2rem;border: 0px; background-color: #ed8b35;"
                                type="primary" class="codeBtn" @click="getCode()">
                                {{ code ==
                                    '获取验证码' ?
                                    code
                                    :
                        ...
                        <div style="margin: 20px;"></div>
                        <p @click="countLoginPart"><i style="margin-right: .2rem;" class="fa fa-user-o "></i>用户登录</p>
                    </div>
                    ...
                    <div v-if="isEmail">
                        ...
                        <div style="margin: 20px" />
                        <div class="code">
                            <el-input style="width: 45%;height: 2rem;" v-model="emailInfo.code" placeholder="验证码" />
                    ...
                    <el-button class="login_btn" style="width: 100%; border: 0px; background-color: #eb7e1e;" type="primary"
                ...
                <div class="bottom_login btn-group">
                    <a class="btn btn-default" style="color: #040000;"  href="https://github.com/vuejs/" title="github" target="_blank"
                        rel="noopener noreferrer"><i class="fa fa-brands fa-github  fa-2x"></i></a>
                    <a @click="emailLoginPart" class="btn btn-default" style="margin-left: 40px; color: #ed8b35;" href="#"><i
                            class="fa fa-regular fa-envelope  fa-2x"></i></a>
                    <a class="btn btn-default" style="margin-left: 40px; color: #0084d0;" href="#"><i
                            class="fa fa-brands fa-qq  fa-2x"></i></a>
                </div>
            </div>
...
import { getEmailCode, getPhoneCode, countLogin, phoneLogin, emailLogin } from '../api/login'
...
const getCode = async () => {
    ...
    document.querySelector(".codeBtn").setAttribute("disabled", true)
        ...
        if (data.code == 200) {
            document.querySelector(".codeBtn").style.backgroundColor = "#7e8c8d !important"
            code.value = 60
